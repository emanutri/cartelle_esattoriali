    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          <a class="dropdown-item" href="${pageContext.request.contextPath}/contribuente/search">Ricerca Contribuenti</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/contribuente/insert">Inserisci Contribuente</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/cartellaesattoriale/search">Ricerca Cartelle Esattoriali</a>
          <a class="dropdown-item" href="${pageContext.request.contextPath}/cartellaesattoriale/insert">Inserisci Cartella Esattoriale</a>
        </div>
      </li>
